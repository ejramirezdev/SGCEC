...
<html lang="en">
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>MODIFICAR REGISTRO DEL PERSONAL</h2>
                    </div>
                </div>
            </div>
        </div>
 ...
 <form action="modificar_proceso_personal.php?id=<?php echo $row['id']; ?>" method="post" id="cdr">
                                        <div class="row">

                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Número de Cédula:</label>
                                                <input class="form-control" placeholder="Cédula:" type="text" name="cedula" value="<?php echo $row['cedula']; ?>" required>
                                                    
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Nombres Completos:</label>
                                                <input class="form-control" placeholder="Nombres:" type="text" name="nombres" value="<?php echo $row['nombres']; ?>" required>
                                                    
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Apellidos Completos:</label>
                                                <input class="form-control" placeholder="Apellidos" type="text" name="apellidos" value="<?php echo $row['apellidos']; ?>" required>
                                            ...
                                            <label for="inputEstado">Estado <value="<?php echo $row['estado']; ?>"></label>
                                            <select id="estado" class="form-control">
                                            <option selected>Personal</option>
                                            <option selected>Pasante</option>
                                            </select>
                                            </div>
