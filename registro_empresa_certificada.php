...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Registro Empresas Certificadas</title>
                  ...
                  <div class="menu-area">
                     <div class="limit-box">
                        ...
                        <ul class="menu-area-main">
                            ...
                            <li><a href="#">Opción</a>
                             ...
                             <li>
                                <br><div id="mostrar" align="right">
                                    <form action="tabla_empresas_certificadas.php" method="post">
                            ...
                            <li>
                                <br><div id="mostrar" align="right">
                                    <form action="rpt_registro_ec.php" method="post" target="_blank">
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>REGISTRO EMPRESA CERTIFICADA</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
      <div class="row"> 
         <div class="about_box">
            ...
            <form action="guardar_empresa_certificada.php" method="post" enctype="multipart/form-data">
               <div class="row">

                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>R.U.C:</label>
                     <input class="form-control" placeholder="R.U.C" type="text" name="ruc" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Nombre/ empresa:</label>
                     <input class="form-control" placeholder="Nombre de la empresa" type="text" name="empresa" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Establecimiento:</label>
                     <input class="form-control" placeholder="Establecimiento" type="text" name="establecimiento" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Alcance/ Certificación:</label>
                     <input class="form-control" placeholder="Alcance/ Certificación" type="text" name="alcance" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>No. Certificación:</label>
                     <input class="form-control" placeholder="No. Certificado" type="text" name="ncertificado" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Vigencia / Certificación:</label>
                     <input class="form-control" placeholder="Vigencia/ Certificación" type="date" name="vcertificacion" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Vigencia / Actualizada:</label>
                     <input class="form-control" placeholder="Vigencia/ Actualizada" type="date" name="vactualizada">
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                     <label>Estado:</label>
                     <input class="form-control" placeholder="Estado (Vigente)" type="text" name="estado" required>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
