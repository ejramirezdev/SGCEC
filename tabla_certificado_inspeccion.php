       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>CERTIFICADOS DE INSPECCIÓN</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  ...
                  <th scope="col">Nuevo</th>
                    <th colspan="12" scope="col"><center>Lista Certificados de Inspección</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><center><b>Fecha de Inspección</b></center></td>
                    <td><center><b>Equipo de Inspectores</b></center></td>
                    <td><center><b>Fecha de Expedición del Certificado</b></center></td>
                    <td><center><b>Fecha vigencia del Certificado</b></center></td>
                    <td><center><b>Fecha de actualización del certificado</b></center></td>
            ...
            <?php
				...
				$query="SELECT * FROM certificadosinspeccion order by id ASC";
                $query="SELECT * FROM certificadosinspeccion order by fi ASC";
				$resultado= $conexion->query($query);
				while($row=$resultado->fetch_assoc()){
			?>	
       
       <tr>
                    <td><center><?php echo $row['ti']; ?></center></td>
                    <td><center><?php echo $row['codigo']; ?></center></td>
                    <td><center><?php echo $row['cliente']; ?></center></td>
                    <td><center><?php echo $row['fi']; ?></center></td>
                    <td><center><?php echo $row['ei']; ?></center></td>
                    <td><center><?php echo $row['fec']; ?></center></td>
                    <td><center><?php echo $row['fvc']; ?></center></td>
                    <td><center><?php echo $row['fac']; ?></center></td>
                    <td><center><?php echo $row['va']; ?></center></td>
                    <td><center><?php echo $row['observaciones']; ?></center></td>
                    <td><center><a href="modificar_certificados_inspeccion.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_certificados_inspeccion.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
