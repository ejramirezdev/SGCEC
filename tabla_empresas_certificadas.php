...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Lista de empresas certificadas</title>
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>LISTA DE EMPRESA CERTIFICADA</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                    <th scope="col"><a href="registro_empresa_certificada.php"><center>Nuevo</center></a></th>
                    <th colspan="9" scope="col"><center>Lista de empresas certificadas</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    
                    <td><center><b>R.U.C</b></center></td>
                    <td><center><b>Empresa</b></center></td>
                    <td><center><b>Establecimiento</b></center></td>
                    <td><center><b>Alcance/ Certificación</b></center></td>
                    <td><center><b>No. Certificado</b></center></td>
                    <td><center><b>Vigencia de la certificación</b></center></td>
                    <td><center><b>Vigencia Actualizada</b></center></td>
       ...
       <?php
				...
				$query="SELECT * FROM empresacertificada order by id DESC";
                $query="SELECT * FROM empresacertificada order by vcertificacion DESC";
				$resultado= $conexion->query($query);
				while($row=$resultado->fetch_assoc()){
			?>	
       
       <tr>
                    <td><center><?php echo $row['ruc']; ?></center></td>
                    <td><center><?php echo $row['empresa']; ?></center></td>
                    <td><center><?php echo $row['establecimiento']; ?></center></td>
                    <td><center><?php echo $row['alcance']; ?></center></td>
                    <td><center><?php echo $row['ncertificado']; ?></center></td>
                    <td><center><?php echo $row['vcertificacion']; ?></center></td>
                    <td><center><?php echo $row['vactualizada']; ?></center></td>
                    <td><center><?php echo $row['estado']; ?></center></td>
                    <td><center><a href="modificar_empresa_certificada.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_empresas_certificadas.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
