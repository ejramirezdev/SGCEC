...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Mensajes- Contáctenos</title>
...
<div class="about">
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  ...
                  <th scope="col"><a href="rpt_tabla_contactenos.php"><center>Reporte</center></a></th>
                    <th colspan="9" scope="col"><center>Datos Contáctenos</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
				...
				$query="SELECT * FROM contactenos order by id DESC";
       ...
       <tr>
                    ...
                    <td><center><?php echo $row['mensaje']; ?></center></td>
                    <td><center><a href="eliminar_msj_contactenos.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
