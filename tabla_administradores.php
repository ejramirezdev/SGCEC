   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                    <th scope="col"><a href="registro_administradores.php">Nuevo</a></th>
                    <th colspan="9" scope="col"><center>Lista de administradores</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><center><b>Contraseña</b></center></td>
                    <td><center><b>Privilegio</b></center></td>
       ...
       <tr>
                    ...
                    <td><center><?php echo $row['contrasena']; ?></center></td>
                    <td><center><?php echo $row['privilegio']; ?></center></td>
                    <td><center><?php echo $row['estado']; ?></center></td>
                    <td><center><a href="modificar_administradores.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_administradores.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
