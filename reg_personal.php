      ...
      <form action="guardar_personal.php" method="post">
                                        <div class="row">
                                            ...
                                            <label>Teléfono Celular:</label>
                                                <input class="form-control" placeholder="Teléfono celular" type="text" name="telefono">
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <label>Nombre de la empresa:</label>
                                                <input class="form-control" placeholder="Empresa" type="text"
                                                    name="empresa">
                                            </div>
                                            ...
                                            <option value="Activo">Personal</option>
                                             <option value="Inactivo">Pasante</option>
                                            </select>
                                            </div>
