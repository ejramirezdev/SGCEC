       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>CLIENTES REGISTRADOS CURSOS GRATIS</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
				...
				$query="SELECT * FROM formulario_cursos order by id DESC";
       ...
       <tr>
                    ...
                    <td><center><a href="eliminar_form_cursos_gratis.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
