...
class CertificadosController {
 ...
 $calificacionDecimal = bcdiv($calificacionDecimal, '1', 2);
            ...
            $this->getPDF()->AddPage();
            $this->getPDF()->image('assets/FPDF/img/borde.png',10,10,277,190);
            $this->getPDF()->image('assets/FPDF/img/Foto_cursos.png',98,25,100,30);
            ...
            $this->getPDF()->image('assets/FPDF/img/firma.png',105,135,100,30);
