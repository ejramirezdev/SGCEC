   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                    <th scope="col"><a href="registro_certificado.php">Nuevo</a></th>
                    <th colspan="9" scope="col"><center>Lista de Capacitados</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><center><b>T. Curso</b></center></td>
                    <td><center><b>Fecha de Certificación</b></center></td>
                    <td><center><b>Fecha Emisión</b></center></td>
                    <td><center><b>Fecha de Vigencia</b></center></td>
				...
				$query="SELECT * FROM certificacionpersonas order by id DESC";
                $query="SELECT * FROM certificacionpersonas order by fcert DESC";
                $query="SELECT * FROM certificacionpersonas order by femision DESC";
       ...
       <tr>
                    ...
                    <td><center><?php echo $row['nya']; ?></center></td>
                    ...
                    <td><center><?php echo $row['tcurso']; ?></center></td>
                    <td><center><?php echo $row['fcert']; ?></center></td>
                    <td><center><?php echo $row['femision']; ?></center></td>
                    <td><center><?php echo $row['fvigencia']; ?></center></td>
                    <td><center><a href="modificar_certificado.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_certificado.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
