                  ...
                  <div class="menu-area">
                     <div class="limit-box">
                        ...
                        <ul class="menu-area-main">
                            ...
                            <li><a href="#">Opción</a>
                             ...
                             <li>
                                <br><div id="mostrar" align="right">
                                    <form action="tabla_certificado.php" method="post">
                            ...
                            <li>
                                <br><div id="mostrar" align="right">
                                    <form action="rpt_registro_certificados.php" method="post" target="_blank">
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>REGISTRO CERTIFICACIÓN DE PERSONAS</h2>
                    </div>
                </div>
            </div>
        </div>
         ...
         <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Cédula o Pasaporte:</label>
                  <input class="form-control" placeholder="Cédula o Pasaporte:" type="text"
                  name="cedula">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Empresa:</label>
                  <input class="form-control" placeholder="Nombre de la empresa:" type="text"
                  name="empresa">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Tipo:</label>
                  <input class="form-control" placeholder="Curso / Certificación" type="text"
                  name="tcurso">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Fecha Certificación:</label>
                  <input class="form-control" placeholder="Fecha Certificación:" type="date"
                  name="fcert">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Fecha de emisión:</label>
                     <input class="form-control" placeholder="Fecha de emisión:" type="date"
                     name="femision">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
               <label>Fecha de vigencia:</label>
                  <input class="form-control" placeholder="Fecha de vigencia:" type="date"
                     name="fvigencia">
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
