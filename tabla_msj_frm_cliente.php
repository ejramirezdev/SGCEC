...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Mensajes Formulario cliente</title>
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>DATOS FORMULARIO CLIENTE</h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="about">
   <div class="container">
            ...
            <table class="table table-striped">
                <thead>
                  ...
                  <th scope="col"><a href="pregunta.php"><center>Volver</center></a></th>
                    <th scope="col"><a href="rpt_msj_frm_cliente.php"><center>Reporte</center></a></th>
                    <th colspan="9" scope="col"><center>Datos Formulario cliente</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><center><b>Correo electrónico</b></center></td>
                    <td><center><b>Empresa/ Institución</b></center></td>
				...
				$query="SELECT * FROM formulariocliente order by id DESC";
       ...
       <tr>
                    ...
                    <td><center><?php echo $row['motivo']; ?></center></td>
                    <td><center><a href="eliminar_msj_frm_cliente.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
