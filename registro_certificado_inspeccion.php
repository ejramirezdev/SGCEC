                            ...
                            <li><a href="#">Opción</a>
                             ...
                             <li>
                                <br><div id="mostrar" align="right">
                                    <form action="tabla_certificado_inspeccion.php" method="post">
...
<div class="about">
   <div class="container">
      ...
      <form action="guardar_certificado_inspeccion.php" method="post">
                                        <div class="row">

                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Tipo de Inspección:</label>
                                                <input class="form-control" placeholder="Tipo de Inspección:" type="text"
                                                    name="ti" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Código:</label>
                                            ...
                                            <label>Fecha de Inspección:</label>
                                                <input class="form-control" placeholder="Fecha de Inspección:" type="text"
                                                    name="fi" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Equipo de Inspectores:</label>
                                                <input class="form-control" placeholder="Equipo de Inspectores:" type="text" name="ei" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Fecha de Expedición del Certificado:</label>
                                                <input class="form-control" placeholder="Fecha de Expedición del Certificado:" type="text"
                                                    name="fec" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Fecha vigencia del certificado:</label>
                                                <input class="form-control" placeholder="Fecha vigencia del certificado:" type="text"
                                                    name="fvc" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Fecha de actualización del certificado:</label>
                                                <input class="form-control" placeholder="Fecha de actualización del certificado:" type="text"
                                                    name="fac" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Vigencia años:</label>
                                                <input class="form-control" placeholder="Vigencia años:" type="text"
                                                    name="va" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <button type="submit" class="btn btn-primary">Limpiar</button></center>
                                            </div>
                                        </div>
                                    </form>
