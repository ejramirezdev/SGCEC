...
<html lang="en">
 ...
 <form action="modificar_proceso_administradores.php?id=<?php echo $row['id']; ?>" method="post" id="cdr">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                                <label>Usuario:</label>
                                                <input class="form-control" placeholder="Usuario" type="text" name="usuario" value="<?php echo $row['usuario']; ?>" required> 
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                                <label>Contraseña:</label>
                                                <input class="form-control" placeholder="Contraseña" type="text" name="contrasena" value="<?php echo $row['contrasena']; ?>" required>     
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Privilegio:</label>
                                                <input class="form-control" placeholder="Administrador/ Empleado" type="text"
                                                    name="privilegio" value="<?php echo $row['privilegio']; ?>" required>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                            <label>Estado:</label>
