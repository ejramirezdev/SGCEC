       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>LISTA DE REGISTRO DEL PERSONAL</h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="about">
   <div class="container">
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th colspan="9" scope="col"><center>Lista de registro del Personal</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td><center><b>Teléfono celular</b></center></td>
       ...
       <tr>
                    ...
                    <td><center><a href="modificar_reg_personal.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_reg_personal.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
