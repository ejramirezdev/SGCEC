...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Lista de Vehiculos inspeccionados</title>
       ...
       <div class="brand_color">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>LISTA DE VEHICULOS INSPECCIONADOS</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <div class="container">
          ...
          <div class="textos_descripcion">
            ...
            <table class="table table-striped">
                <thead>
                  <tr>
                  <th scope="col"><a href="registro_insp_vehicular.php"><center>Nuevo</center></a></th>
                    <th colspan="12" scope="col"><center>Lista de Vehículos Inspeccionados</center></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    
                    <td><center><b>Tipo de inspección</b></center></td>
                    <td><center><b>Código</b></center></td>
                    <td><center><b>Cliente</b></center></td>
                    <td><center><b>Placa</b></center></td>
                    <td><center><b>F.de inspección</b></center></td>
                    <td><center><b>Eq. inspectores</b></center></td>
                    <td><center><b>Exp. certificado</b></center></td>
                    <td><center><b>Vigencia certificado</b></center></td>
                    <td><center><b>Act. certificado</b></center></td>
                    <td><center><b>Vigencia años</b></center></td>
                    <td><center><b>Observación</b></center></td>
				...
				$query="SELECT * FROM inspvehicular order by id DESC";
				$resultado= $conexion->query($query);
				while($row=$resultado->fetch_assoc()){
			?>	
       
       <tr>
                    <td><center><?php echo $row['inspeccion']; ?></center></td>
                    <td><center><?php echo $row['codigo']; ?></center></td>
                    <td><center><?php echo $row['cliente']; ?></center></td>
                    <td><center><?php echo $row['placa']; ?></center></td>
                    <td><center><?php echo $row['finspeccion']; ?></center></td>
                    <td><center><?php echo $row['einspectores']; ?></center></td>
                    <td><center><?php echo $row['expcertificado']; ?></center></td>
                    <td><center><?php echo $row['vigcertificado']; ?></center></td>
                    <td><center><?php echo $row['actcertificado']; ?></center></td>
                    <td><center><?php echo $row['viganios']; ?></center></td>
                    <td><center><?php echo $row['observacion']; ?></center></td>
                    <td><center><a href="modificar_insp_vehiculo.php?id=<?php echo $row['id']; ?>">Modificar</a></center></td>
                    <td><center><a href="eliminar_insp_vehicular.php?id=<?php echo $row['id']; ?>">Eliminar</a></center></td>
                </tr>
            <?php
				}
			?>	
